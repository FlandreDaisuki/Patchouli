...
// @require    https://unpkg.com/vue-i18n@8.12.0/dist/vue-i18n.min.js
// @require    https://unpkg.com/sentinel-js@0.0.5/dist/sentinel.min.js
...
(function (Vue, VueI18n, Vuex) {
  ...
  const waitUntil = async(func, { ms = 33, maxCount = 60 } = {}) => {
    const _t = Date.now();
  ...
  const waitReady = async(func, { ms } = {}) => waitUntil(func, { maxCount: Infinity, ms });
  Vue.use(VueI18n);
  const en = {
    config: {
      blacklist: 'Blacklist',
  ...
  const state$2 = {
    data: null,
    mode: COVER_LAYER_MODE.NONE,
  };
  const mutations$2 = {
    close: (state) => {
      state.mode = COVER_LAYER_MODE.NONE;
    },
    open: (state, payload) => {
  ...
  var script$2 = {
    ...
    methods: {
      ...
      openCoverLayerInConfigMode() {
        this.$store.commit('coverLayer/open', { data: null, mode: COVER_LAYER_MODE.CONFIG });
      },
      optionsChange(event) {
  ...
  var __vue_render__$2 = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{ref:_vm.id,attrs:{"id":_vm.id}},[_c('span',{staticClass:"koakuma-block",attrs:{"id":"koakuma-processed-block"}},[_vm._v(_vm._s(_vm.processedCountMsg))]),_vm._v(" "),_c('div',{staticClass:"koakuma-block",attrs:{"id":"koakuma-bookmark-sort-block"}},[_c('label',{attrs:{"id":"koakuma-bookmark-sort-label","for":"koakuma-bookmark-sort-input"}},[_c('span',[_vm._v("❤️")]),_vm._v(" "),_c('input',{attrs:{"id":"koakuma-bookmark-sort-input","type":"number","min":"0","step":"1"},domProps:{"value":_vm.filters.limit},on:{"wheel":function($event){$event.stopPropagation();$event.preventDefault();return _vm.sortInputWheel($event)},"input":_vm.sortInputInput}})]),_vm._v(" "),_c('a',{attrs:{"id":"koakuma-bookmark-input-usual-switch","role":"button"},on:{"click":function($event){if(!$event.type.indexOf('key')&&_vm._k($event.keyCode,"left",37,$event.key,["Left","ArrowLeft"])){ return null; }if('button' in $event && $event.button !== 0){ return null; }_vm.usualSwitchOn = !_vm.usualSwitchOn;}}},[_c('FontAwesomeIcon',{attrs:{"icon":'angle-down'}})],1),_vm._v(" "),_c('ul',{directives:[{name:"show",rawName:"v-show",value:(_vm.usualSwitchOn),expression:"usualSwitchOn"}],attrs:{"id":"koakuma-bookmark-input-usual-list"}},_vm._l((_vm.usualList),function(usual){return _c('li',{key:usual},[_c('span',{staticClass:"sort-order-apply-indicator"},[_vm._v("⮬")]),_vm._v(" "),_c('a',{staticClass:"usual-list-link",attrs:{"role":"button"},on:{"click":function($event){if(!$event.type.indexOf('key')&&_vm._k($event.keyCode,"left",37,$event.key,["Left","ArrowLeft"])){ return null; }if('button' in $event && $event.button !== 0){ return null; }return _vm.clickUsual($event)}}},[_vm._v(_vm._s(usual))])])}),0)]),_vm._v(" "),_c('div',{staticClass:"koakuma-block"},[_c('input',{attrs:{"id":"koakuma-bookmark-tags-filter-input","placeholder":_vm.$t('ctrlPanel.tagFilterQueryPlaceholder'),"type":"text"},on:{"input":_vm.tagsFilterInput}})]),_vm._v(" "),_c('div',{staticClass:"koakuma-block"},[_c('button',{class:_vm.statusClass,attrs:{"id":"koakuma-main-button","disabled":_vm.status.isEnded},on:{"mouseup":function($event){if(!$event.type.indexOf('key')&&_vm._k($event.keyCode,"left",37,$event.key,["Left","ArrowLeft"])){ return null; }if('button' in $event && $event.button !== 0){ return null; }return _vm.clickMainButton($event)}}},[_vm._v(_vm._s(_vm.buttonMsg))])]),_vm._v(" "),_c('div',{staticClass:"koakuma-block",attrs:{"id":"koakuma-sorting-order-block"}},[_c('a',{attrs:{"id":"koakuma-sorting-order-select-switch","role":"button"},on:{"click":function($event){if(!$event.type.indexOf('key')&&_vm._k($event.keyCode,"left",37,$event.key,["Left","ArrowLeft"])){ return null; }if('button' in $event && $event.button !== 0){ return null; }_vm.sortingOrderSwitchOn = !_vm.sortingOrderSwitchOn;}}},[_c('output',{attrs:{"id":"koakuma-sorting-order-select-output"},domProps:{"innerHTML":_vm._s(_vm.sortingOrderMsg)}}),_vm._v(" "),_c('FontAwesomeIcon',{attrs:{"icon":'angle-down'}})],1),_vm._v(" "),_c('ul',{directives:[{name:"show",rawName:"v-show",value:(_vm.sortingOrderSwitchOn),expression:"sortingOrderSwitchOn"}],attrs:{"id":"koakuma-sorting-order-select-list"}},[_c('li',[_c('span',{staticClass:"sort-order-apply-indicator"},[_vm._v("⮬")]),_vm._v(" "),_c('a',{staticClass:"sorting-order-link",attrs:{"id":"koakuma-sorting-order-by-popularity","role":"button"},on:{"click":function($event){if(!$event.type.indexOf('key')&&_vm._k($event.keyCode,"left",37,$event.key,["Left","ArrowLeft"])){ return null; }if('button' in $event && $event.button !== 0){ return null; }return _vm.clickSortingOrder($event)}}},[_vm._v(_vm._s(_vm.$t('ctrlPanel.sortByPopularity')))])]),_vm._v(" "),_c('li',[_c('span',{staticClass:"sort-order-apply-indicator"},[_vm._v("⮬")]),_vm._v(" "),_c('a',{staticClass:"sorting-order-link",attrs:{"id":"koakuma-sorting-order-by-date","role":"button"},on:{"click":function($event){if(!$event.type.indexOf('key')&&_vm._k($event.keyCode,"left",37,$event.key,["Left","ArrowLeft"])){ return null; }if('button' in $event && $event.button !== 0){ return null; }return _vm.clickSortingOrder($event)}}},[_vm._v(_vm._s(_vm.$t('ctrlPanel.sortByDate')))])]),_vm._v(" "),_c('li',{directives:[{name:"show",rawName:"v-show",value:(_vm.isSelfBookmarkPage),expression:"isSelfBookmarkPage"}]},[_c('span',{staticClass:"sort-order-apply-indicator"},[_vm._v("⮬")]),_vm._v(" "),_c('a',{staticClass:"sorting-order-link",attrs:{"id":"koakuma-sorting-order-by-bookmark-id","role":"button"},on:{"click":function($event){if(!$event.type.indexOf('key')&&_vm._k($event.keyCode,"left",37,$event.key,["Left","ArrowLeft"])){ return null; }if('button' in $event && $event.button !== 0){ return null; }return _vm.clickSortingOrder($event)}}},[_vm._v(_vm._s(_vm.$t('ctrlPanel.sortByBookmarkId')))])])])]),_vm._v(" "),_c('div',{staticClass:"koakuma-block",attrs:{"id":"koakuma-display-options-block"}},[_c('div',{directives:[{name:"show",rawName:"v-show",value:(!_vm.isSelfBookmarkPage),expression:"!isSelfBookmarkPage"}],on:{"click":function($event){if(!$event.type.indexOf('key')&&_vm._k($event.keyCode,"left",37,$event.key,["Left","ArrowLeft"])){ return null; }if('button' in $event && $event.button !== 0){ return null; }return _vm.toggleUnbookmarkedOnly($event)}}},[_c('IconLayeredHearts',{attrs:{"id":"koakuma-display-options-unbookmarked-only","double":_vm.unbookmarkedOnly}})],1)]),_vm._v(" "),_c('div',{staticClass:"koakuma-block",attrs:{"id":"koakuma-options-block"}},[_c('div',{on:{"click":function($event){if(!$event.type.indexOf('key')&&_vm._k($event.keyCode,"left",37,$event.key,["Left","ArrowLeft"])){ return null; }if('button' in $event && $event.button !== 0){ return null; }return _vm.optionsChange($event)}}},[_c('FontAwesomeIcon',{directives:[{name:"show",rawName:"v-show",value:(_vm.xc.fitwidth),expression:"xc.fitwidth"}],attrs:{"id":"koakuma-options-width-compress","icon":'compress'}}),_vm._v(" "),_c('FontAwesomeIcon',{directives:[{name:"show",rawName:"v-show",value:(!_vm.xc.fitwidth),expression:"!xc.fitwidth"}],attrs:{"id":"koakuma-options-width-expand","icon":'expand'}})],1),_vm._v(" "),_c('div',{on:{"click":function($event){if(!$event.type.indexOf('key')&&_vm._k($event.keyCode,"left",37,$event.key,["Left","ArrowLeft"])){ return null; }if('button' in $event && $event.button !== 0){ return null; }return _vm.openCoverLayerInConfigMode($event)}}},[_c('FontAwesomeIcon',{attrs:{"id":"koakuma-options-config","icon":'cog'}})],1)])])};
  var __vue_staticRenderFns__$2 = [];
    const __vue_inject_styles__$2 = function (inject) {
      if (!inject) return
      inject("data-v-221ee3ce_0", { source: "a[data-v-221ee3ce]{color:#258fb8;text-decoration:none}a[role=button]>.fa-angle-down[data-v-221ee3ce]{padding:2px;height:16px}#Koakuma[data-v-221ee3ce]{display:flex;justify-content:center;align-items:center;position:sticky;top:0;z-index:3;background-color:#eef;box-shadow:0 1px 1px #777;padding:4px;color:#00186c;font-size:16px}.koakuma-block[data-v-221ee3ce]{margin:0 10px;display:inline-flex}#koakuma-processed-block[data-v-221ee3ce]{font-size:18px}#koakuma-bookmark-sort-label[data-v-221ee3ce]{display:inline-flex!important;align-items:center;margin-right:0;border-radius:3px 0 0 3px;background-color:#cef;color:#0069b1;margin:0 1px;padding:0 6px}#koakuma-bookmark-sort-block[data-v-221ee3ce],#koakuma-sorting-order-block[data-v-221ee3ce]{position:relative;box-shadow:0 0 1px #069;border-radius:4px}#koakuma-sorting-order-block[data-v-221ee3ce]{background-color:#cef}#koakuma-bookmark-sort-input[data-v-221ee3ce]{-moz-appearance:textfield;border:none;background-color:transparent;padding:0;color:inherit;font-size:16px;display:inline-block;cursor:ns-resize;text-align:center;max-width:50px}#koakuma-bookmark-sort-input[data-v-221ee3ce]::-webkit-inner-spin-button,#koakuma-bookmark-sort-input[data-v-221ee3ce]::-webkit-outer-spin-button{-webkit-appearance:none;margin:0}#koakuma-bookmark-tags-filter-input[data-v-221ee3ce]{margin:0;padding:0 4px;color:#333;font-size:12px;border:1px solid #becad7;height:20px;min-width:300px}#koakuma-bookmark-tags-filter-input[data-v-221ee3ce]:focus{background:#ffc;outline:0}#koakuma-bookmark-input-usual-switch[data-v-221ee3ce],#koakuma-sorting-order-select-switch[data-v-221ee3ce]{background-color:#cef;padding:1px;border-left:1px solid #888;border-radius:0 3px 3px 0;cursor:pointer;display:inline-flex;align-items:center}#koakuma-sorting-order-select-switch[data-v-221ee3ce]{border:none;border-radius:3px}#koakuma-bookmark-input-usual-list[data-v-221ee3ce],#koakuma-sorting-order-select-list[data-v-221ee3ce]{border-radius:3px;background-color:#cef;box-shadow:0 0 2px #069;position:absolute;top:100%;width:100%;margin-top:1px;list-style:none;padding:0}#koakuma-sorting-order-select-list[data-v-221ee3ce]{display:grid;grid-auto-columns:max-content;width:initial}#koakuma-bookmark-input-usual-list>li[data-v-221ee3ce],#koakuma-sorting-order-select-list>li[data-v-221ee3ce]{display:flex;position:relative;line-height:24px}#koakuma-bookmark-input-usual-list>li[data-v-221ee3ce]::after,#koakuma-sorting-order-select-list>li[data-v-221ee3ce]::after{content:\"\";box-shadow:0 0 0 1px #89d8ff;display:inline-block;margin:0;height:0;line-height:0;font-size:0;position:absolute;left:0;right:0;width:100%;transform:scaleX(.8)}#koakuma-bookmark-input-usual-list>li[data-v-221ee3ce]:first-child::after,#koakuma-sorting-order-select-list>li[data-v-221ee3ce]:first-child::after{box-shadow:none}#koakuma-bookmark-input-usual-list .sort-order-apply-indicator[data-v-221ee3ce],#koakuma-sorting-order-select-list .sort-order-apply-indicator[data-v-221ee3ce]{visibility:hidden}#koakuma-bookmark-input-usual-list .sort-order-apply-indicator[data-v-221ee3ce]{position:absolute}#koakuma-bookmark-input-usual-list>li:hover .sort-order-apply-indicator[data-v-221ee3ce],#koakuma-sorting-order-select-list>li:hover .sort-order-apply-indicator[data-v-221ee3ce]{visibility:visible}.sort-order-apply-indicator[data-v-221ee3ce]{display:block;justify-content:center;align-items:center;font-weight:bolder;padding:0 4px}.sorting-order-link[data-v-221ee3ce],.usual-list-link[data-v-221ee3ce]{display:block;cursor:pointer;text-align:center;flex:1}.sorting-order-link[data-v-221ee3ce]{padding-right:18px}#koakuma-sorting-order-select-output[data-v-221ee3ce]{padding:0 16px;display:flex;align-items:center}#koakuma-sorting-order-select[data-v-221ee3ce]{font-size:14px}#koakuma-display-options-block>*[data-v-221ee3ce],#koakuma-options-block>*[data-v-221ee3ce]{margin:0 5px;display:inline-flex;align-items:center}#koakuma-main-button[data-v-221ee3ce]{border:none;padding:2px 14px;border-radius:3px;font-size:16px}#koakuma-main-button[data-v-221ee3ce]:enabled{transform:translate(-1px,-1px);box-shadow:1px 1px 1px #4c4c4c;cursor:pointer}#koakuma-main-button[data-v-221ee3ce]:enabled:hover{transform:translate(0);box-shadow:none}#koakuma-main-button[data-v-221ee3ce]:enabled:active{transform:translate(1px,1px);box-shadow:-1px -1px 1px #4c4c4c}#koakuma-main-button.go[data-v-221ee3ce]{background-color:#00ff59}#koakuma-main-button.paused[data-v-221ee3ce]{background-color:#feff00}#koakuma-main-button.end[data-v-221ee3ce]{background-color:#878787;color:#fff;opacity:.87}#koakuma-display-options-unbookmarked-only[data-v-221ee3ce],#koakuma-options-config[data-v-221ee3ce],#koakuma-options-width-compress[data-v-221ee3ce],#koakuma-options-width-expand[data-v-221ee3ce]{height:20px;cursor:pointer}", map: undefined, media: undefined });
    };
    const __vue_scope_id__$2 = "data-v-221ee3ce";
  ...
  var __vue_staticRenderFns__$4 = [];
    ...
    const __vue_scope_id__$4 = "data-v-0b17ca5d";
  ...
  var __vue_staticRenderFns__$5 = [];
    ...
    const __vue_scope_id__$5 = "data-v-688ed66c";
  ...
  var __vue_staticRenderFns__$6 = [];
    ...
    const __vue_scope_id__$6 = "data-v-24bf7204";
  ...
  var __vue_staticRenderFns__$7 = [];
    const __vue_inject_styles__$7 = function (inject) {
      if (!inject) return
      inject("data-v-1dca3e80_0", { source: ".image-item-image[data-v-1dca3e80]{display:flex;align-items:center;justify-content:center;position:relative}.image-flexbox[data-v-1dca3e80]{display:flex;flex-flow:column;justify-content:center;align-items:center;z-index:0;border:1px solid rgba(0,0,0,.04);position:relative;height:var(--default-image-item-image-square-size);width:var(--default-image-item-image-square-size)}.image-flexbox[data-v-1dca3e80]:hover{text-decoration:none}.top-right-slot[data-v-1dca3e80]{flex:none;display:flex;align-items:center;z-index:1;box-sizing:border-box;margin:0 0 -24px auto;padding:6px;height:24px;background:#000;background:rgba(0,0,0,.4);border-radius:0 0 0 4px;color:#fff;font-size:12px;line-height:1;font-weight:700}.ugoira-icon[data-v-1dca3e80]{position:absolute}canvas[data-v-1dca3e80],img[data-v-1dca3e80]{max-height:100%;max-width:100%}.bookmark-input-container[data-v-1dca3e80]{position:absolute;left:0;top:0;background:rgba(0,0,0,.4);padding:6px;border-radius:0 0 4px 0}.bookmark-heart-block[data-v-1dca3e80]{position:absolute;bottom:0;right:0}", map: undefined, media: undefined });
    };
    const __vue_scope_id__$7 = "data-v-1dca3e80";
  ...
  var __vue_staticRenderFns__$9 = [];
    ...
    const __vue_scope_id__$9 = "data-v-149e5fa6";
  ...
  var __vue_staticRenderFns__$a = [];
    const __vue_inject_styles__$a = function (inject) {
      if (!inject) return
      inject("data-v-57a66298_0", { source: "#patchouli-default-image-item-page[data-v-57a66298]{display:flex;flex-flow:wrap;justify-content:space-around}", map: undefined, media: undefined });
    };
    const __vue_scope_id__$a = "data-v-57a66298";
  ...
  var __vue_staticRenderFns__$b = [];
    const __vue_inject_styles__$b = function (inject) {
      if (!inject) return
      inject("data-v-4a7bb1d4_0", { source: ".illust-item-root[data-v-4a7bb1d4]{margin:0 12px 24px}.illust-main[data-v-4a7bb1d4]{text-decoration:none}.illust-main-indicators[data-v-4a7bb1d4]{display:flex;position:absolute;width:var(--new-default-image-item-square-size);justify-content:end}.illust-main-img[data-v-4a7bb1d4]{align-items:center;background-color:#fff;background-position:50%;background-repeat:no-repeat;background-size:cover;border-radius:4px;display:flex;height:var(--new-default-image-item-square-size);justify-content:center;margin-bottom:8px;position:relative;width:var(--new-default-image-item-square-size)}.illust-main-img[data-v-4a7bb1d4]::before{background-color:rgba(0,0,0,.02);content:\"\";display:block;height:100%;left:0;position:absolute;top:0;width:100%}.illust-main-ugoira[data-v-4a7bb1d4]{object-fit:contain;height:var(--new-default-image-item-square-size);width:var(--new-default-image-item-square-size)}.illust-buttons[data-v-4a7bb1d4]{display:flex;height:32px;justify-content:flex-end;margin-bottom:8px;margin-top:-40px}.illust-buttons>div[data-v-4a7bb1d4]{z-index:1}.illust-buttons>div>button[data-v-4a7bb1d4]{background:0 0;border:none;box-sizing:content-box;cursor:pointer;display:inline-block;height:32px;line-height:1;padding:0}.illust-title[data-v-4a7bb1d4]{color:#177082;display:block;font-size:14px;font-weight:700;line-height:1;margin:0 0 4px;overflow:hidden;text-decoration:none;text-overflow:ellipsis;white-space:nowrap;width:var(--new-default-image-item-square-size)}.user-profile[data-v-4a7bb1d4]{align-items:center;display:flex;width:var(--new-default-image-item-square-size);margin-bottom:4px}.user-profile>div[data-v-4a7bb1d4]{display:inline-block;margin-right:4px}.user-profile-img[data-v-4a7bb1d4]{background-size:cover;border-radius:50%;display:block;flex:none;position:relative;overflow:hidden;width:16px;height:16px}.user-profile-name[data-v-4a7bb1d4]{color:#999;font-size:12px;line-height:1;overflow:hidden;text-decoration:none;text-overflow:ellipsis;white-space:nowrap;flex:1}.user-followed-indicator[data-v-4a7bb1d4]{display:inline-block;margin-left:4px;width:16px;height:16px;color:#1e90ff}.illust-popularity[data-v-4a7bb1d4]{display:flex;width:100%;justify-content:center}.illust-popularity>span[data-v-4a7bb1d4]{background-color:#cef;color:#0069b1;padding:2px 8px;border-radius:8px;font-weight:700}.illust-popularity>span[data-v-4a7bb1d4]::before{content:\"❤️\";margin-right:4px}", map: undefined, media: undefined });
    };
    const __vue_scope_id__$b = "data-v-4a7bb1d4";
  ...
  var __vue_staticRenderFns__$c = [function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"ils-grid"},[_c('div',{staticClass:"ils-cell ils-1"}),_vm._v(" "),_c('div',{staticClass:"ils-cell ils-2"}),_vm._v(" "),_c('div',{staticClass:"ils-cell ils-3"}),_vm._v(" "),_c('div',{staticClass:"ils-cell ils-4"}),_vm._v(" "),_c('div',{staticClass:"ils-cell ils-5"}),_vm._v(" "),_c('div',{staticClass:"ils-cell ils-6"}),_vm._v(" "),_c('div',{staticClass:"ils-cell ils-7"}),_vm._v(" "),_c('div',{staticClass:"ils-cell ils-8"}),_vm._v(" "),_c('div',{staticClass:"ils-cell ils-9"})])}];
    const __vue_inject_styles__$c = function (inject) {
      if (!inject) return
      inject("data-v-6d2f62f6_0", { source: ".ils-grid[data-v-6d2f62f6]{width:var(--loading-icon-size);height:var(--loading-icon-size);margin:100px auto}.ils-grid .ils-cell[data-v-6d2f62f6]{width:33%;height:33%;background-color:var(--loading-icon-color);float:left;-webkit-animation:ilsGridScaleDelay-data-v-6d2f62f6 1.3s infinite ease-in-out;animation:ilsGridScaleDelay-data-v-6d2f62f6 1.3s infinite ease-in-out}.ils-grid .ils-1[data-v-6d2f62f6]{-webkit-animation-delay:.2s;animation-delay:.2s}.ils-grid .ils-2[data-v-6d2f62f6]{-webkit-animation-delay:.3s;animation-delay:.3s}.ils-grid .ils-3[data-v-6d2f62f6]{-webkit-animation-delay:.4s;animation-delay:.4s}.ils-grid .ils-4[data-v-6d2f62f6]{-webkit-animation-delay:.1s;animation-delay:.1s}.ils-grid .ils-5[data-v-6d2f62f6]{-webkit-animation-delay:.2s;animation-delay:.2s}.ils-grid .ils-6[data-v-6d2f62f6]{-webkit-animation-delay:.3s;animation-delay:.3s}.ils-grid .ils-7[data-v-6d2f62f6]{-webkit-animation-delay:0s;animation-delay:0s}.ils-grid .ils-8[data-v-6d2f62f6]{-webkit-animation-delay:.1s;animation-delay:.1s}.ils-grid .ils-9[data-v-6d2f62f6]{-webkit-animation-delay:.2s;animation-delay:.2s}@-webkit-keyframes ilsGridScaleDelay-data-v-6d2f62f6{0%,100%,70%{-webkit-transform:scale3D(1,1,1);transform:scale3D(1,1,1)}35%{-webkit-transform:scale3D(0,0,1);transform:scale3D(0,0,1)}}@keyframes ilsGridScaleDelay-data-v-6d2f62f6{0%,100%,70%{-webkit-transform:scale3D(1,1,1);transform:scale3D(1,1,1)}35%{-webkit-transform:scale3D(0,0,1);transform:scale3D(0,0,1)}}", map: undefined, media: undefined });
    };
    const __vue_scope_id__$c = "data-v-6d2f62f6";
  ...
  var __vue_staticRenderFns__$e = [];
    ...
    const __vue_scope_id__$e = "data-v-ace52af6";
  ...
  var __vue_render__$f = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{on:{"click":function($event){$event.stopPropagation();}}},[_c('a',{attrs:{"id":"config-context-menu-switch"},on:{"click":function($event){if(!$event.type.indexOf('key')&&_vm._k($event.keyCode,"left",37,$event.key,["Left","ArrowLeft"])){ return null; }if('button' in $event && $event.button !== 0){ return null; }$event.stopPropagation();return _vm.clickSwitch($event)}}},[_c('a',{directives:[{name:"show",rawName:"v-show",value:(_vm.xc.contextMenu),expression:"xc.contextMenu"}],attrs:{"id":"config-context-menu-switch-on","role":"button"}},[_c('FontAwesomeIcon',{attrs:{"icon":'toggle-on'}})],1),_vm._v(" "),_c('a',{directives:[{name:"show",rawName:"v-show",value:(!_vm.xc.contextMenu),expression:"!xc.contextMenu"}],attrs:{"id":"config-context-menu-switch-off","role":"button"}},[_c('FontAwesomeIcon',{attrs:{"icon":'toggle-off'}})],1),_vm._v(" "),_c('span',{attrs:{"id":"config-context-menu-label"}},[_vm._v(_vm._s(_vm.$t('config.contextMenuExtension')))])]),_vm._v(" "),_c('a',{attrs:{"id":"config-user-tooltip-switch"},on:{"click":function($event){if(!$event.type.indexOf('key')&&_vm._k($event.keyCode,"left",37,$event.key,["Left","ArrowLeft"])){ return null; }if('button' in $event && $event.button !== 0){ return null; }$event.stopPropagation();return _vm.clickSwitch($event)}}},[_c('a',{directives:[{name:"show",rawName:"v-show",value:(_vm.xc.userTooltip),expression:"xc.userTooltip"}],attrs:{"id":"config-user-tooltip-switch-on","role":"button"}},[_c('FontAwesomeIcon',{attrs:{"icon":'toggle-on'}})],1),_vm._v(" "),_c('a',{directives:[{name:"show",rawName:"v-show",value:(!_vm.xc.userTooltip),expression:"!xc.userTooltip"}],attrs:{"id":"config-user-tooltip-switch-off","role":"button"}},[_c('FontAwesomeIcon',{attrs:{"icon":'toggle-off'}})],1),_vm._v(" "),_c('span',{attrs:{"id":"config-user-tooltip-label"}},[_vm._v(_vm._s(_vm.$t('config.userTooltip')))])]),_vm._v(" "),_c('a',{attrs:{"id":"config-hover-play-switch"},on:{"click":function($event){if(!$event.type.indexOf('key')&&_vm._k($event.keyCode,"left",37,$event.key,["Left","ArrowLeft"])){ return null; }if('button' in $event && $event.button !== 0){ return null; }$event.stopPropagation();return _vm.clickSwitch($event)}}},[_c('a',{directives:[{name:"show",rawName:"v-show",value:(_vm.xc.hoverPlay),expression:"xc.hoverPlay"}],attrs:{"id":"config-hover-play-switch-on","role":"button"}},[_c('FontAwesomeIcon',{attrs:{"icon":'toggle-on'}})],1),_vm._v(" "),_c('a',{directives:[{name:"show",rawName:"v-show",value:(!_vm.xc.hoverPlay),expression:"!xc.hoverPlay"}],attrs:{"id":"config-hover-play-switch-off","role":"button"}},[_c('FontAwesomeIcon',{attrs:{"icon":'toggle-off'}})],1),_vm._v(" "),_c('span',{attrs:{"id":"config-hover-play-label"}},[_vm._v(_vm._s(_vm.$t('config.hoverPlay')))])]),_vm._v(" "),_c('a',{attrs:{"id":"marisa-config-blacklist-label"}},[_c('FontAwesomeIcon',{attrs:{"icon":'eye-slash'}}),_vm._v("\n    "+_vm._s(_vm.$t('config.blacklist'))+"\n  ")],1),_vm._v(" "),_c('textarea',{ref:"blacklistTextarea",attrs:{"id":"marisa-config-blacklist-textarea","spellcheck":"false","rows":"5"},domProps:{"value":_vm.xc.blacklist.join('\n')}})])};
  var __vue_staticRenderFns__$f = [];
    const __vue_inject_styles__$f = function (inject) {
      if (!inject) return
      inject("data-v-599dcf15_0", { source: "#marisa-config-mode a[data-v-599dcf15]{color:#00186c;text-decoration:none;display:inline-flex}#marisa-config-mode>a[data-v-599dcf15]{align-items:center;justify-content:center;margin:2px 0}#marisa-config-mode [id$=switch][data-v-599dcf15]{cursor:pointer}#marisa-config-mode svg[data-v-599dcf15]{height:18px;margin:0 4px}#marisa-config-blacklist-textarea[data-v-599dcf15]{box-sizing:border-box;flex:1;resize:none;font-size:11pt;height:90px}", map: undefined, media: undefined });
    };
    const __vue_scope_id__$f = "data-v-599dcf15";
    const __vue_module_identifier__$f = undefined;
    const __vue_is_functional_template__$f = false;
    var CoverLayerConfig = normalizeComponent_1(
  ...
  var __vue_render__$g = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{ref:"coverLayerPreviewRoot",attrs:{"tabindex":"0"},on:{"keyup":_vm.jumpByKeyup,"wheel":function($event){$event.stopPropagation();$event.preventDefault();return _vm.jumpByWheel($event)},"click":function($event){$event.stopPropagation();}}},[_c('div',{attrs:{"id":"marisa-preview-display-area"}},[_c('a',{directives:[{name:"show",rawName:"v-show",value:(!_vm.previewUgoiraMetaData),expression:"!previewUgoiraMetaData"}],attrs:{"href":_vm.previewSrcList[_vm.previewCurrentIndex],"rel":"noreferrer noopener","target":"_blank"}},[_c('img',{attrs:{"src":_vm.previewSrcList[_vm.previewCurrentIndex]}})]),_vm._v(" "),_c('div',{directives:[{name:"show",rawName:"v-show",value:(!!_vm.previewUgoiraMetaData),expression:"!!previewUgoiraMetaData"}]},[_c('canvas',{directives:[{name:"show",rawName:"v-show",value:(_vm.previewCurrentIndex === 0),expression:"previewCurrentIndex === 0"}],ref:"previewUgoiraCanvas"}),_vm._v(" "),_c('canvas',{directives:[{name:"show",rawName:"v-show",value:(_vm.previewCurrentIndex === 1),expression:"previewCurrentIndex === 1"}],ref:"previewOriginalUgoiraCanvas"})])]),_vm._v(" "),_c('ul',{directives:[{name:"show",rawName:"v-show",value:(_vm.previewSrcList.length > 1),expression:"previewSrcList.length > 1"}],attrs:{"id":"marisa-preview-thumbnails-area"}},_vm._l((_vm.previewSrcList),function(pSrc,index){return _c('li',{key:pSrc},[_c('a',{class:(index === _vm.previewCurrentIndex) ? 'current-preview' : '',on:{"click":function($event){if(!$event.type.indexOf('key')&&_vm._k($event.keyCode,"left",37,$event.key,["Left","ArrowLeft"])){ return null; }if('button' in $event && $event.button !== 0){ return null; }return _vm.jumpTo(index)}}},[_c('img',{attrs:{"src":pSrc}})])])}),0)])};
  var __vue_staticRenderFns__$g = [];
    const __vue_inject_styles__$g = function (inject) {
      if (!inject) return
      inject("data-v-651654f8_0", { source: "#marisa-preview-display-area[data-v-651654f8]{border:2px #00186c solid;box-sizing:border-box;text-align:center}#marisa-preview-display-area>a[data-v-651654f8],#marisa-preview-display-area>div[data-v-651654f8]{display:inline-flex;height:100%;justify-content:center;align-items:center}#marisa-preview-display-area>a>img[data-v-651654f8],#marisa-preview-display-area>div>canvas[data-v-651654f8]{object-fit:contain;max-width:100%;max-height:100%}#marisa-preview-thumbnails-area[data-v-651654f8]{background-color:#f8f8ff;display:flex;align-items:center;overflow-x:auto;overflow-y:hidden;height:100%;border:2px solid #014;box-sizing:border-box;border-top:0;margin:0;padding:0;list-style:none}#marisa-preview-thumbnails-area>li[data-v-651654f8]{margin:0 10px;display:inline-flex}#marisa-preview-thumbnails-area>li>a[data-v-651654f8]{cursor:pointer;display:inline-flex;border:3px solid transparent}#marisa-preview-thumbnails-area>li>a.current-preview[data-v-651654f8]{border:3px solid #db7093}#marisa-preview-thumbnails-area>li>a>img[data-v-651654f8]{max-height:100px;box-sizing:border-box;display:inline-block}", map: undefined, media: undefined });
    };
    const __vue_scope_id__$g = "data-v-651654f8";
    const __vue_module_identifier__$g = undefined;
    const __vue_is_functional_template__$g = false;
    var CoverLayerPreview = normalizeComponent_1(
  ...
  var script$h = {
    ...
    computed: {
      showConfig() {
        return this.xmode === COVER_LAYER_MODE.CONFIG;
      },
      showPreview() {
        return this.xmode === COVER_LAYER_MODE.PREVIEW;
      },
      showRoot() {
        return this.xmode !== COVER_LAYER_MODE.NONE;
      },
      xmode() {
  ...
  var __vue_render__$h = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{directives:[{name:"show",rawName:"v-show",value:(_vm.showRoot),expression:"showRoot"}],attrs:{"id":_vm.id},on:{"click":function($event){if(!$event.type.indexOf('key')&&_vm._k($event.keyCode,"left",37,$event.key,["Left","ArrowLeft"])){ return null; }if('button' in $event && $event.button !== 0){ return null; }return _vm.clickBase($event)},"scroll":function($event){$event.stopPropagation();$event.preventDefault();},"wheel":function($event){$event.stopPropagation();$event.preventDefault();}}},[_c('CoverLayerConfig',{directives:[{name:"show",rawName:"v-show",value:(_vm.showConfig),expression:"showConfig"}],attrs:{"id":"marisa-config-mode","active":_vm.showConfig}}),_vm._v(" "),_c('CoverLayerPreview',{directives:[{name:"show",rawName:"v-show",value:(_vm.showPreview),expression:"showPreview"}],attrs:{"id":"marisa-preview-mode","active":_vm.showPreview}})],1)};
  var __vue_staticRenderFns__$h = [];
    const __vue_inject_styles__$h = function (inject) {
      if (!inject) return
      inject("data-v-292c4bf5_0", { source: "#Marisa[data-v-292c4bf5]{background-color:#000a;position:fixed;height:100%;width:100%;z-index:5;top:0;left:0;display:flex;align-items:center;justify-content:center}#marisa-preview-mode[data-v-292c4bf5]{width:70%;height:100%;min-width:100px;min-height:100px;background-color:#eef;box-sizing:border-box;display:grid;grid-template-rows:minmax(0,auto) max-content}#marisa-config-mode[data-v-292c4bf5]{display:flex;flex-flow:column;padding:10px;border-radius:10px;font-size:18px;white-space:nowrap;min-width:100px;min-height:100px;background-color:#eef}", map: undefined, media: undefined });
    };
    const __vue_scope_id__$h = "data-v-292c4bf5";
